  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <View style={styles.mainView}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: '9%', marginBottom: '10%' }}>
          <TouchableOpacity
            activeOpacity={0.7}
            style={[styles.btnl, { backgroundColor: currentSlide == 0 ? '#F0F0F0' : '#1B1464' }]}
            onPress={goToPreviousSlide}>
            <MaterialIcons name={'navigate-before'} size={36} color={currentSlide == 0 ? '#8A8A8A' : '#F0F0F0'} />
          </TouchableOpacity>
          <TouchableOpacity
            activeOpacity={0.7}
