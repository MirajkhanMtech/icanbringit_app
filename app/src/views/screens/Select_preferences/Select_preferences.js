                ...
                <View style={styles.mainView}>
                    ...
                    <View style={{ marginHorizontal: '7%', marginTop: '25%' }}>
                            ...
                            <FlatList
                                ...
                                renderItem={({ item, index }) => {
                                    return <TouchableOpacity
                                        ...
                                        style={[
                                            index === clickedId ? [styles.optionsView, { backgroundColor: '#3FA9F5' }] : [styles.optionsView, { backgroundColor: 'white' }]]}>

                                        <Text style={[
                                            index === clickedId ? [styles.text, { color: 'white' }] : [styles.text, { color: 'black' }]]}>
                                            {item.head}
                                        </Text>
                                ...
                                <FlatList
                                    ...
                                    renderItem={({ item, index }) => {
                                        return <TouchableOpacity
                                            ...
                                            style={[
                                                index === clickedId1 ? [styles.optionsView, { backgroundColor: '#3FA9F5' }] : [styles.optionsView, { backgroundColor: 'white' }]]}>

                                            <Text style={[
                                                index === clickedId1 ? [styles.text, { color: 'white' }] : [styles.text, { color: 'black' }]]}>
                                                {item.head}
                                            </Text>
                                ...
                                : <FlatList
                                    ...
                                    renderItem={({ item, index }) => {
                                        return <TouchableOpacity
                                            ...
                                            style={[
                                                index === clickedId2 ? [styles.optionsView, { backgroundColor: '#3FA9F5' }] : [styles.optionsView, { backgroundColor: 'white' }]]}>

                                            <Text style={[
                                                index === clickedId2 ? [styles.text, { color: 'white' }] : [styles.text, { color: 'black' }]]}>
                                                {item.head}
                                            </Text>
                        ...
                        <View style={styles.v1}>
                            <Text style={styles.txt1}>{count}<Text style={styles.txt2}>/3</Text></Text>
                            <TouchableOpacity
                                activeOpacity={0.7}
                        ...
                        <ProgressBar progress={count == 1 ? 0.3 : count == 2 ? 0.6 : count == 3 ? 1 : 0} color={'#3FA9F5'} style={styles.p} />
                    </View>
                </View>
            </ScrollView>
        </SafeAreaView >
