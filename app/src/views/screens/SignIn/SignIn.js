        ...
        <SafeAreaView style={{ flex: 1 }}>
            <ScrollView style={{ backgroundColor: 'white' }}>
                ...
                <View style={styles.mainView}>
                    ...
                    <View style={{ marginHorizontal: '7%', marginTop: '6%' }}>
                        <EmailInput title={'Enter Your Email '} />
                        <PasswordInput title={'Your password'} />
                        <Text onPress={() => {navigation.navigate('Forget_Password') }} style={styles.txt}>Forget Password?</Text>
                    </View>
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={styles.txt2}>Don’t have an account?
                            <Text style={styles.txt3}> Sign Up
                            </Text></Text>
                    </TouchableOpacity>
                </View>
